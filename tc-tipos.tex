...
Siempre se puede saber el tamaño en bytes de un tipo de datos aplicando el operador \lstinline{sizeof()} a una
...
a=19.27 * b;	
\end{lstlisting}
\lstinline{a} contendrá los bits menos significativos del resultado de evaluar la expresión de la
